...
class BookControllerTest {
	...
	void setUp() throws Exception {
		book1 = new BookDTO(1l, "Book 1", "Author 1", "ISBN-1", 100.00, "Book 1 Description", 1l);
		book2 = new BookDTO(2l, "Book 2", "Author 2", "ISBN-2", 100.00, "Book 2 Description", 2l);
		book3 = new BookDTO(3l, "Book 3", "Author 3", "ISBN-3", 100.00, "Book 3 Description", 3l);
	}
